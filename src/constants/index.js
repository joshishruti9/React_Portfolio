...
export const EXPERIENCES = [
  {
    ...
    company: "Mastercard (Pune, India)",
        description: `At Mastercard, I worked in the Loyalty and Benefits team, developing user-facing applications using Java, React, and Spring Boot. I leveraged Axon Framework to build event-driven microservices, processing over 20,000+ daily events with high scalability and performance, leading to a 20% boost in customer engagement. I automated tests for four microservices with the Karate framework, achieving 98% regression test coverage and improving testing efficiency, which enhanced service resiliency by 30%. My experience with cloud technologies, particularly AWS, ensured seamless deployment and scalability. Additionally, I automated to CI/CD pipeline using XLR for artifact publishing, streamlining release processes. Collaborating with solution architects, I explored domain-driven design, expanding my expertise in system architecture. This role sharpened my skills in full-stack development, event sourcing, cloud technologies, and continuous integration.`,
